                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Detail Alumni</h5>
                                </div>
                                {{-- <ul class="breadcrumb">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <select name="is_diterima" id="is_diterima" class=" form-select" disabled>
                                                    <option value="0"
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            @if ($xfoto != null)
                                                <div class="col-10">
                                                    <input type="file" class="validation-file" id="foto"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <input type="text" class="form-control" name="tempat_lahir"
                                                    id="tempat_lahir" value="{{ $profil->tempat_lahir }}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-2">
                                                <input type="date" class="form-control" name="tanggal_lahir"
                                                    id="tanggal_lahir" value="{{ $profil->tanggal_lahir }}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-10">
                                                <select class="form-select" id="id_agama" name="id_agama" disabled>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <textarea class="form-control" name="alamat" id="alamat" cols="30" rows="3" disabled>{{ $profil->alamat }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-10">
                                                <input type="text" class=" form-control" name="kodepos"
                                                    id="kodepos" value="{{ $profil->kodepos }}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <select class="form-select" id="id_jurusan" name="id_jurusan" disabled>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="{{ $profil->asal_sekolah_universitas }}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-10">
                                                <input type="text" class="form-control" name="nilai_ijazah_ipk"
                                                    ...
                                                    oninput="this.value = this.value.replace(/,/g, '.');" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-10">
                                                <input type="number" class=" form-control" name="whatsapp"
                                                    id="whatsapp" value="{{ $profil->user->whatsapp }}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-2">
