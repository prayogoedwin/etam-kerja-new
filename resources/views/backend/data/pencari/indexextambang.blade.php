                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Pencari Kerja Ex Tambang</h5>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#simpletable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('datapencariextambang.index') }}',
            ...
            $('#downloadCsv').on('click', function() {
                ...
                // var url = '{{ route('datapencaridisabilitas.exportCsv') }}?search=' + searchTerm;

                // // Redirect ke URL ekspor CSV
                // window.location.href = url;

                alert('Fitur unduh CSV belum diimplementasikan. Silakan hubungi admin untuk informasi lebih lanjut.');
            });
        });
    </script>
@endpush
