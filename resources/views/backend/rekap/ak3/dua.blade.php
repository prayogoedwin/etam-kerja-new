                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Rekap IPK III/2</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Filter Form -->
                            <form method="GET" action="{{ route('rekap.ak32') }}" class="mb-4 no-print">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ route('rekap.ak32') }}" class="btn btn-secondary btn-sm">
                            ...
                            <div class="row align-items-center m-l-0 mb-3">
                                <div class="col-sm-12 text-center">
                                    <h5>IPK III/2: PENCARI KERJA YANG TERDAFTAR, DITEMPATKAN DAN DIHAPUSKAN</h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tableIPK32">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th colspan="2">Penempatan<br><small>Bulan Ini</small></th>
...
function exportToExcel() {
    // Clone table untuk export
    var table = document.getElementById('tableIPK32');
    ...
    XLSX.utils.book_append_sheet(wb, ws, "IPK III-2");
    
    // Generate filename
    var filename = "IPK_III_2_{{ $namaBulan }}_{{ $tahun }}.xlsx";
