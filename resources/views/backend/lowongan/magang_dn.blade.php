                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Lowongan Magang Pemerintah - {{ $magang->nama_magang }}</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('magang_dn.index') }}">Magang
                                            Pemerintah</a></li>
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('magang_dn.perusahaan', $magangId) }}">Perusahaan</a></li>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center m-l-0">
                                    <div class="col-sm-6">
                                        ...
                                        <p class="text-muted mb-0">Magang Pemerintah: {{ $magang->nama_magang }}</p>
                                    </div>
                                    <div class="col-sm-6 text-end">
                                        <a href="{{ route('magang_dn.perusahaan', $magangId) }}"
                                            class="btn btn-secondary btn-sm btn-round me-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label for="jab">Tanggal Selesai <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" class="form-control" name="tanggal_end"
                                                id="tanggal_end" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="judul_lowongan">Judul Lowongan <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status_perkawinan_id" name="marital_id"
                                            required>
                    ...
                    <div class="modal-body">
                        <form id="editForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="judul_lowongan_edit">Judul Lowongan <span
                                                class="text-danger">*</span></label>
                        ...
                        <form id="editAdminForm">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="">Disediakan untuk</label>
                                    <select class="form-select" name="is_lowongan_disabilitas"
                                        id="is_lowongan_disabilitas_e" style="width: 100%;" disabled>
                                        <option value="0">Umum</option>
                                        <option value="1">Disabilitas</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="kisaran_gaji"
                                            id="kisaran_gaji_e" disabled>
                                    </div>
                                    <div class="col-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#simpletable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('magang_dn.lowongan', [$magangId, $userId]) }}',
                autoWidth: false,
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
        ...
        $('#tambahForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('magang_dn.lowongan.store', [$magangId, $userId]) }}',
                data: $(this).serialize(),
        ...
        $('#editForm').submit(function(e) {
            ...
            var url =
                "{{ route('magang_dn.lowongan.update', ['magangId' => ':magangId', 'userId' => ':userId', 'id' => ':id']) }}"
                .replace(':magangId', {{ $magangId }})
        ...
        function showEditLowonganModal(id) {
            ...
            $.ajax({
                url: `/magang_dn/${magangId}/perusahaan/${userId}/lowongan/${id}`,
                type: 'GET',
                success: function(response) {
                    if (response.success) {
