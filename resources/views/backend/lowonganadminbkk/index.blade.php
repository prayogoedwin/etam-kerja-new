                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Lowongan Kerja BKK</h5>
                                </div>
                                {{-- <ul class="breadcrumb">
                        ...
                        <form id="editAdminForm">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="is_lowongan_disabilitas" id="is_lowongan_disabilitas"
                                        disabled>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_id" id="status_id" required>
                                        ...
                                        <option value="3">Lowongan Ditutup</option>
                                    </select>
                                </div>
                            </div>

                            <div class="col-sm-12">
                                <button class="float-end btn btn-warning" onclick="updateData()"
...
@push('js')
    <script>
        $(document).ready(function() {
            $('#simpletable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('lowonganbkk.admin.index') }}',
    ...
    <script>
        function showEditModal(id) {
            var detailUrl = "{{ route('lowongan.admin.detail', ':id') }}".replace(':id', id);
            $.ajax({
                url: detailUrl,
                type: 'GET',
                success: function(response) {
    ...
    <script>
        function updateData() {
            ...
            var id = $('#editId').val();
            var stsid = $('#status_id').val();

            // Send the data to the update route
            $.ajax({
                url: "{{ route('lowongan.admin.update', ':id') }}".replace(':id', id),
                type: 'PUT',
                data: {
