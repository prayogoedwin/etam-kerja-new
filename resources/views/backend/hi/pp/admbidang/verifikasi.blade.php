                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Verifikasi Pengajuan</h5>
                            ...
                            <div class="card-body">
                                ...
                                <form id="form-verifikasi" action="{{ route('hi.pp.admbidang.verifikasi.submit', $ajuan->id) }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="type-acc" value="acc"
                                                    {{ (int) $ajuan->verifikasi_admin === 1 ? 'checked' : '' }} required>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="type-revisi" value="revisi"
                                                    {{ (int) $ajuan->verifikasi_admin === 2 ? 'checked' : '' }}>
                                    ...
                                    {{-- Field yang muncul hanya kalau REVISI --}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="keterangan" id="keterangan" class="form-control" rows="4"
                                                        maxlength="255"
                                                        placeholder="Jelaskan alasan revisi...">{{ old('keterangan', $ajuan->keterangan_revisi_admin) }}</textarea>
                                    ...
                                    <div class="d-flex justify-content-end mt-4">
                                        <a href="{{ route('hi.pp.admbidang.detail', $ajuan->id) }}" class="btn btn-light">
                                            Batal
                                        </a>
...
<script>
    $(function () {
        // Tampilkan / sembunyikan field revisi
        ...
        $('input[name="type"]').on('change', toggleKeterangan);
        toggleKeterangan(); // initial state
