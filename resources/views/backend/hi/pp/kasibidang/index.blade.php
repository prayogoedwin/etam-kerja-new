...
@section('title', 'Verifikasi Kasi — Peraturan Perusahaan')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center m-l-0 mb-3">
                                <div class="col-sm-6">
                                    <h5 class="mb-0">Daftar Pengajuan — Verifikasi Kasi</h5>
                                    <small class="badge badge-light-info">Hanya menampilkan ajuan yang sudah di-ACC Admin</small>
                                </div>
                            </div>

                            <div class="table-responsive">
                                <table id="table-ajuan" class="table table-bordered table-striped mb-0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Jenis Ajuan</th>
...
<script>
$(function () {
    $('#table-ajuan').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('hi.pp.kasibidang.index') }}',
        autoWidth: false,
        columns: [
