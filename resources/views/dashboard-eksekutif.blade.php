...
<head>
    ...
    <title>Dashboard Eksekutif - Ketenagakerjaan</title>
            ...
            <div class="card-column">
                ...
                <div class="card card-pencari">
                    ...
                    <div class="card-body">
                        ...
                        <div class="section-title">📍 Top 3 Kab/Kota</div>
                        <div class="kota-list">
                            @forelse($pencari['top_kota'] as $index => $kota)
                            <div class="kota-item">
                                <span class="kota-rank">#{{ $index + 1 }}</span>
                                <span class="kota-name">{{ $kota->nama }}</span>
                                <span class="kota-count">{{ number_format($kota->total) }}</span>
                            </div>
                            @empty
                            <div class="kota-item">
            ...
            <div class="card-column">
                <div class="card card-penyedia">
                    ...
                    <div class="card-body">
                        ...
                        <div class="section-title">📍 Top 10 Kab/Kota</div>
                        <div class="kota-list">
                            @forelse($penyedia['top_kota'] as $index => $kota)
                            <div class="kota-item">
                                <span class="kota-rank">#{{ $index + 1 }}</span>
                                <span class="kota-name">{{ $kota->nama }}</span>
                                <span class="kota-count">{{ number_format($kota->total) }}</span>
            ...
            <div class="card-column">
                <div class="card card-lowongan">
                    ...
                    <div class="card-body">
                        ...
                        <div class="section-title">📍 Top 5 Kab/Kota</div>
                        <div class="kota-list">
                            @forelse($lowongan['top_kota'] as $index => $kota)
                            <div class="kota-item">
                                <span class="kota-rank">#{{ $index + 1 }}</span>
                                <span class="kota-name">{{ $kota->nama }}</span>
                                <span class="kota-count">{{ number_format($kota->total) }}</span>
