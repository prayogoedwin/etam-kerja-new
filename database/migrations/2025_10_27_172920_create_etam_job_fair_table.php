...
return new class extends Migration
{
    ...
    {
        Schema::create('etam_job_fair', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('nama_job_fair')->nullable();
            $table->string('slug')->nullable()->unique();
            $table->string('penyelenggara')->nullable();
            $table->text('deskripsi')->nullable();
            $table->string('poster')->nullable();
            $table->integer('tipe_job_fair')->comment('0: online, 1: offline');
    ...
    {
        Schema::dropIfExists('etam_job_fair');
    }
};