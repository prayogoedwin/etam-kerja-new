...
class EtamGaleriController extends Controller
{
    //
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $datas = EtamGaleri::select('id', 'name', 'path_file', 'status');
        ...
        return view('backend.setting.galeri.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('path_file')) {
            ...
            $filePath = $file->store('galeri', 'public'); // Menyimpan file di folder storage/app/public/galeri
        }
