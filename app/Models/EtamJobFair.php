...
class EtamJobFair extends Model
{
     ...
     */
    public function scopeTipeJobFair($query, $tipe)
    {
        return $query->where('tipe_job_fair', $tipe);
    }
